...
def Lambda(T, nH, nH0, nHe0, nHep, nC0, nC1, nC2): #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  ne = nHp + nHep + 2.0 * nHepp + (nC1 + 2.0 * nC2) #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
#----- n_tot
def n_tot(nH, nH0, nHe0, nHep, nC, nC0, nC1, nC2): #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  
  nHp = nH - nH0

  nHepp = nHe - nHe0 - nHep
  
  ne = nHp + nHep + 2.0 * nHepp + (nC1 + 2. * nC2) #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
def func(t, y):
  ...
  dnC2_dt = 10**C_1_2(Tx) * ne * nC1 - 10**C_2_1(Tx) * ne * nC2 - 10**C_2_3(Tx) * ne * nC2
  
  Lamb = Lambda(T, nH, nH0, nHe0, nHep, nC0, nC1, nC2) #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  
  ntot = n_tot(nH, nH0, nHe0, nHep, nC, nC0, nC1, nC2) #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

  dT_dt = -1.0 * (gamma - 1.0) / kB / ntot * Lamb
  
  return [dnH0_dt, dnHe0_dt, dnHep_dt, dnC0_dt, dnC1_dt, dnC2_dt, dT_dt] #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
y0 = [1e-3, 1.6e-6, 6e-3, 1e-4, 1e-4, 1e-4, 1e6] #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
res = []
for Tx, nH0x, nHe0x, nHepx, nC0x, nC1x, nC2x in zip(T, nH0, nHe0, nHep, nC0, nC1, nC2): #!!!!!!!!!!!!!!!!!!!!!

  lmb = Lambda(Tx, nH, nH0x, nHe0x, nHepx, nC0x, nC1x, nC2x) #!!!!!!!!!!!!!!!!!!!!!!!!!!
