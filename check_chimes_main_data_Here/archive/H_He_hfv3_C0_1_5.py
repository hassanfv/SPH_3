...
def Lambda(T, nH, nH0, nHe0, nHep, nC0, nC1, nC2, nC3, nC4, nC5): #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  ne = nHp + nHep + 2.0 * nHepp + (nC1 + 2.0 * nC2 + 3. * nC3 + 4. * nC4 + 5. * nC5) #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
def n_tot(nH, nH0, nHe0, nHep, nC, nC0, nC1, nC2, nC3, nC4, nC5): #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  ne = nHp + nHep + 2.0 * nHepp + (nC1 + 2. * nC2 + 3. * nC3 + 4. * nC4 + 5. * nC5) #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
def func(t, y):
  ...
  dnC5_dt = 10**C_4_5(Tx) * ne * nC4 - 10**C_5_4(Tx) * ne * nC5 - 10**C_5_6(Tx) * ne * nC5
  
  Lamb = Lambda(T, nH, nH0, nHe0, nHep, nC0, nC1, nC2, nC3, nC4, nC5) #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
y0 = [1e-3, 1.6e-6, 6e-3, 1e-4, 1e-4, 1e-4, 1e-4, 1e-4, 1e-4, 1e6] #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
for Tx, nH0x, nHe0x, nHepx, nC0x, nC1x, nC2x, nC3x, nC4x, nC5x in zip(T, nH0, nHe0, nHep, nC0, nC1, nC2, nC3, nC4, nC5): #!!!!!!!!!!!!!!!!!!!!!
  ...
  lmb = Lambda(Tx, nH, nH0x, nHe0x, nHepx, nC0x, nC1x, nC2x, nC3x, nC4x, nC5x) #!!!!!!!!!!!!!!!!!!!!!!!!!!
