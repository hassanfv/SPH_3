...
def func(t, y):
  ...
  dnHI_dt = (
             ...
             + 10**R_OI_to_OII_via_HII(Tx) * nOI * nHII # important
             - 10**R_OII_to_OI_via_HI(Tx) * nOII * nHI # ERROR
             - 10**R_OIII_to_OII_via_HI(Tx) * nOIII * nHI # checked!!!
             - 10**R_OIV_to_OIII_via_HI(Tx) * nOIV * nHI # checked!!!
             - 10**R_OV_to_OIV_via_HI(Tx) * nOV * nHI # checked !!!
             - 10**R_OVI_to_OV_via_HI(Tx) * nOVI * nHI # checked !!
  ...
  dnHeI_dt = (
              ...
              + 10**R_OI_to_OII_via_HeII(Tx) * nOI * nHeII # checked !!!
              - 10**R_OIII_to_OII_via_HeI(Tx) * nOIII * nHeI # checked!!!
              - 10**R_OIV_to_OIII_via_HeI(Tx) * nOIV * nHeI #checked!!!
              - 10**R_OV_to_OIV_via_HeI(Tx) * nOV * nHeI # checked !!
