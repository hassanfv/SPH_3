...
# This code reproduces the results from Fig_1 top panels of Townsend - 2009 (the circles in Fig_1 are what this code reproduces).
...
for i in np.arange(1, 21, 0.01):
  
  tcool = get_tcool2(T0, nHcgs)
  
  dt = 0.1 * i * tcool
  
  T = update_T(T0, dt, tcool)
