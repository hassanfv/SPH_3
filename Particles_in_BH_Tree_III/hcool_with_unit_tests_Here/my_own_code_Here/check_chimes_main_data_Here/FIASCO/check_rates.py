...
k1 = interp1d(Temp, k1x, kind='linear', fill_value="extrapolate") # Reaction: (H0 + e ---> Hp + 2e) ::: H0 Collisional ionization
k2 = interp1d(Temp, k2x, kind='linear', fill_value="extrapolate") # Reaction: (Hp + e ---> H0 + γ)  ::: photo-recombination of Hp and e.
k3 = interp1d(Temp, k3x, kind='linear', fill_value="extrapolate") # Reaction: (He0 + e ---> Hep + 2e) ::: He0 Collisional ionization 
k4 = interp1d(Temp, k4x, kind='linear', fill_value="extrapolate") # Reaction: (Hep + e ---> Hepp + 2e) ::: Hep Collisional ionization
k5 = interp1d(Temp, k5x, kind='linear', fill_value="extrapolate") # Reaction: (Hep + e ---> He0 + γ)  ::: photo-recombination of Hep and e.
k6 = interp1d(Temp, k6x, kind='linear', fill_value="extrapolate") # Reaction: (Hepp + e ---> Hep + γ)  ::: photo-recombination of Hepp and e.
...
g1 = interp1d(Temp, g1x, kind='linear', fill_value="extrapolate") # cooling via H0
g2 = interp1d(Temp, g2x, kind='linear', fill_value="extrapolate") # cooling via Hp
g3 = interp1d(Temp, g3x, kind='linear', fill_value="extrapolate") # cooling via He0
g4 = interp1d(Temp, g4x, kind='linear', fill_value="extrapolate") # cooling via Hep
g5 = interp1d(Temp, g5x, kind='linear', fill_value="extrapolate") # cooling via Hepp
...
C0_rates = rates_hiT_4d[0, :]
gC0 = interp_4d = interp1d(Temp_hiT_4d, C0_rates, kind='linear', fill_value="extrapolate") # JUST FOR TEST

Cp_rates = rates_hiT_2d[0, :]
gC1 = interp1d(Temp_hiT_2d, Cp_rates, kind='linear', fill_value="extrapolate")

T = np.linspace(4, 8, 100)

plt.plot(10**T, 10**gC0(T), label = 'C0')
plt.plot(10**T, 10**gC1(T), label = 'C1')
plt.plot(10**T, 10**gC2(T), label = 'C2')
plt.plot(10**T, 10**gC3(T), label = 'C3')
plt.plot(10**T, 10**gC4(T), label = 'C4')
plt.plot(10**T, 10**gC5(T), label = 'C5')
plt.plot(10**T, 10**gC6(T), label = 'C6')
