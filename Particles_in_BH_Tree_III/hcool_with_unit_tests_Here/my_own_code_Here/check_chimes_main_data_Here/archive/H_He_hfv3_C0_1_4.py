...
def Lambda(T, nH, nH0, nHe0, nHep, nC0, nC1, nC2, nC3, nC4): #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  ne = nHp + nHep + 2.0 * nHepp + (nC1 + 2.0 * nC2 + 3. * nC3 + 4. * nC4) #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
#----- n_tot
def n_tot(nH, nH0, nHe0, nHep, nC, nC0, nC1, nC2, nC3, nC4): #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  
  nHp = nH - nH0

  nHepp = nHe - nHe0 - nHep
  
  ne = nHp + nHep + 2.0 * nHepp + (nC1 + 2. * nC2 + 3. * nC3 + 4. * nC4) #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
def func(t, y):
  ...
  nH0, nHe0, nHep, nC0, nC1, nC2, nC3, nC4, T = y #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  dnC4_dt = 10**C_3_4(Tx) * ne * nC3 - 10**C_4_3(Tx) * ne * nC4 - 10**C_4_5(Tx) * ne * nC4
  
  Lamb = Lambda(T, nH, nH0, nHe0, nHep, nC0, nC1, nC2, nC3, nC4) #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  
  ntot = n_tot(nH, nH0, nHe0, nHep, nC, nC0, nC1, nC2, nC3, nC4) #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

  dT_dt = -1.0 * (gamma - 1.0) / kB / ntot * Lamb
  
  return [dnH0_dt, dnHe0_dt, dnHep_dt, dnC0_dt, dnC1_dt, dnC2_dt, dnC3_dt, dnC4_dt, dT_dt] #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
y0 = [1e-3, 1.6e-6, 6e-3, 1e-4, 1e-4, 1e-4, 1e-4, 1e-4, 1e6] #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
res = []
for Tx, nH0x, nHe0x, nHepx, nC0x, nC1x, nC2x, nC3x, nC4x in zip(T, nH0, nHe0, nHep, nC0, nC1, nC2, nC3, nC4): #!!!!!!!!!!!!!!!!!!!!!

  lmb = Lambda(Tx, nH, nH0x, nHe0x, nHepx, nC0x, nC1x, nC2x, nC3x, nC4x) #!!!!!!!!!!!!!!!!!!!!!!!!!!
