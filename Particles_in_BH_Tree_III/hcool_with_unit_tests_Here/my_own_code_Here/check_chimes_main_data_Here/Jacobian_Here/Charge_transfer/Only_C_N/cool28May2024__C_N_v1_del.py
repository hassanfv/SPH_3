...
def func(t, y):
    ...
    dnH0_dt = 10**k2(Tx) * nHp * ne - 10**k1(Tx) * nH0 * ne + 10**grain_rec_H_1_0 * nHp * ne
    dnHp_dt = 10**k1(Tx) * nH0 * ne - 10**k2(Tx) * nHp * ne - 10**grain_rec_H_1_0 * nHp * ne
    
    dnHe0_dt = 10**k5(Tx) * nHep * ne - 10**k3(Tx) * nHe0 * ne + 10**grain_rec_He_1_0 * nHep * ne
    
    dnHep_dt = (10**k6(Tx) * nHepp * ne + 10**k3(Tx) * nHe0 * ne - 10**k4(Tx) * nHep * ne - 10**k5(Tx) * nHep * ne +
              - 10** grain_rec_He_1_0 * nHep * ne)
    ...
    dnC0_dt = (10**C_1_0(Tx) * ne * nC1 - 10**C_0_1(Tx) * ne * nC0
             ...
             + 10**ct_C_1_0_H0(Tx) * nC1 * nH0 + 10**grain_rec_C_1_0 * nC1 * ne) 
    ...
    dnC1_dt = (10**C_0_1(Tx) * ne * nC0 + 10**C_2_1(Tx) * ne * nC2 - 10**C_1_0(Tx) * ne * nC1 - 10**C_1_2(Tx) * ne * nC1
             ...
             - 10**ct_C_1_2_Hep(Tx) * nC1 * nHep + 10**ct_C_2_1_H0(Tx) * nC2 * nH0
