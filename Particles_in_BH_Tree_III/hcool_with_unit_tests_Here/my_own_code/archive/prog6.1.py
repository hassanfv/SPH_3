...
# Cooling via He0 collisional excitation - (Cen - 1992) ::: will be multiplied by nHep and ne^2 later in the code
def g11(T):

    g11_val =  9.10e-27 / T**0.1687 / (1 + (T/1e5)**0.5) * np.exp(-13179./T)
...
def Lambda(T, nH, nH0, nHe0, nHep):
  ...
  print(g11(T) * ne * ne * nHep, g12(T) * ne, g1(T) * ne * nH0)
