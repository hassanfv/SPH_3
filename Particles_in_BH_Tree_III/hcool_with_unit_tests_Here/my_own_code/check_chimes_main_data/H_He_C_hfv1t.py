...
t = np.linspace(t_span[0], t_span[1], 1000) # This 10000 is not years, it is the number of points in linspace !!!!

#solution = solve_ivp(func, t_span, y0, method='RK23', dense_output=True)
...
plt.loglog(t/3.16e7, solution[:, 9])
plt.show()
