...
print(np.where(rho == np.median(rho)))
...
nz = np.where(np.abs(z) < 110.015)[0]
...
print('sort nH_cgs = ', np.sort(nH_cgs))

plt.hist(nH_cgs, bins =20)
plt.show()
s()
