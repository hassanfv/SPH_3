...
TGrid = np.arange(2, 11.1, 0.1)  #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ALWAYS CHECK !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
nHGrid = np.arange(-4, 5.1, 0.1) #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ALWAYS CHECK !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
rGrid = np.arange(0.02, 0.73, 0.1)#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ALWAYS CHECK !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
NHGrid = np.arange(16, 23.1, 0.2)#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ALWAYS CHECK !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
with open('HCoolChimes03March2024.bin', 'wb') as file:
    # Writing integers
