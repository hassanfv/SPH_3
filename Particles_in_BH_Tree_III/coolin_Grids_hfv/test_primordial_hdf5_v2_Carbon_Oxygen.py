...
nO0= AbundanceEvolution[iTemp, inH, iZ, 15, :] * 10**densities[inH]
nO1= AbundanceEvolution[iTemp, inH, iZ, 16, :] * 10**densities[inH]
nO2= AbundanceEvolution[iTemp, inH, iZ, 17, :] * 10**densities[inH]
nO3= AbundanceEvolution[iTemp, inH, iZ, 18, :] * 10**densities[inH]
nO4= AbundanceEvolution[iTemp, inH, iZ, 19, :] * 10**densities[inH]
nO5= AbundanceEvolution[iTemp, inH, iZ, 20, :] * 10**densities[inH]
nO6= AbundanceEvolution[iTemp, inH, iZ, 21, :] * 10**densities[inH]
nO7= AbundanceEvolution[iTemp, inH, iZ, 22, :] * 10**densities[inH]
nO8= AbundanceEvolution[iTemp, inH, iZ, 23, :] * 10**densities[inH]
nOm= AbundanceEvolution[iTemp, inH, iZ, 24, :] * 10**densities[inH]
...
with open('chimesRes_C_O.pkl', 'wb') as f:
  pickle.dump(dictx, f)
