...
nH_p, r_p, NH_p, T_p, mu_p = 3.0,0.3,21.8,3.7,0.8787
...
print(f'u_p = {u_p:3f} corresponds to T = {T[nxT0]} and mu = {mu[nxT0]} for nH_p = {nH_p}, r_p = {r_p}, and NH_p = {NH_p}')
print(f'Heat = {Heat[nxT0]},  Cool = {Cool[nxT0]}')
