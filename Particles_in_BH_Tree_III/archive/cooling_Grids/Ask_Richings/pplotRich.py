...
f = h5py.File('grid_noneq_evolution_1.0kpc_HM01.hdf5', 'r')
...
t_Myrs = t_Arr_in_sec / 3600 / 24 / 365.25 / 1e6
...
iTemp = 3
iZ = 1
plt.scatter(t_Myrs, np.log10(TemperatureEvolution[iTemp, inH, iZ, :]), s = 10, label = 'nH = 1e4 cm^-3')

inH = 6
iTemp = 3
iZ = 1
plt.scatter(t_Myrs, np.log10(TemperatureEvolution[iTemp, inH, iZ, :]), s = 10, label = 'nH = 1e5 cm^-3')

inH = 7
iTemp = 3
iZ = 1
plt.scatter(t_Myrs, np.log10(TemperatureEvolution[iTemp, inH, iZ, :]), s = 10, label = 'nH = 1e6 cm^-3')
