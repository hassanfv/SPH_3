...
int main()
{
  ...
  float dt = 5e-4; //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! This is only the first time step !!
...
//--------------------------------------------
  ...
  //------- For ngb_new -----
  int nSplit = 10;//32; // for 3D, never go above 10 as 10^3 = 1000 and the maximum blockSize in GPUs is 1024!! IMPORTANT !!
