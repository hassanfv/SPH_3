...
print(f'mp = {mp:.2E},  mr = {mr:.2E}') # mp should be smaller than mr!
if mp < mr:
  print()
  print('GOOD!! Since mp < mr, the Jeans condition is satisfied, so all is good!')
else:
  print()
  print('DANGER!!! Since mp > mr, the Jeans condition is not satisfied!! Take appropriate actions!!!!')
