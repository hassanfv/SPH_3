...
convert_seconds_to_yr = 1.0 / (60. * 60. * 24. * 365.25) 
...
def plot_temperature_evolution(plotter_pars): 
    ...
    print(T_evolution.shape) # (7, 9, 3, 21) ===> (T, nH, Z, time)
    print(T_evolution[5, 6, 1, :])
    print()
    print(np.log10(T_evolution[5, 6, 1, :]))
    s()

    #time_array *= convert_seconds_to_Myr 
    time_array *= convert_seconds_to_yr 
