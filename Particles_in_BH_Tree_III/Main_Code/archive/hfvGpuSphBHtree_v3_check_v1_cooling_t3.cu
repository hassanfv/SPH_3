...
//--------------------------------------------
  ...
  float *U, *d_U; // They will be used only inside the hcooling function as I could not define them inside the hcooling function (GPU limitations!!)
  ...
  //------- For ngb_new -----
  int nSplit = 32; // for 3D, never go above 10 as 10^3 = 1000 and the maximum blockSize in GPUs is 1024!! IMPORTANT !!
