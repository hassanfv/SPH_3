...
#===== plot_x_vs_y
def plot_x_vs_y(file_ndx, particle_ndx, color):
  ...
  plt.scatter(x[particle_ndx], y[particle_ndx], s=30, color='r') # Here we use original x!
  plt.xlim(0.05, 0.2)
  plt.ylim(-0.05, 0.05)
...
plt.subplot(2, 2, 2)
plot_x_vs_y(file_ndx_1, particle_ndx_1, color1)

plt.subplot(2, 2, 3)
plot_x_vs_y(file_ndx_2, particle_ndx_2, color2)

plt.subplot(2, 2, 4)
plot_x_vs_y(file_ndx_3, particle_ndx_3, color3)
