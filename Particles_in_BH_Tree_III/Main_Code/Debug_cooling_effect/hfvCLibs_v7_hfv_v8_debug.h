...
void saveArraysToBinary(const std::string &filename, float *x, float *y, float *z, float *vx, float *vy, float *vz,
                        float *rho, float *h, float *dudt, float *dudt_pre, float *uBad, float *uAad, float *u, float *mass,int *Typ, int N)
{
  ...
  file.write(reinterpret_cast<const char *>(dudt_pre), N * sizeof(float));
  file.write(reinterpret_cast<const char *>(uBad), N * sizeof(float));
  file.write(reinterpret_cast<const char *>(uAad), N * sizeof(float));
...
//========================== For debugging Cooling ====================================
//=====================================================================================
__global__ void u_after_adiabatic(int *Typ, float *u, float *uA, int N)
{
...
//========================== For debugging Cooling ====================================
//=====================================================================================
__global__ void u_after_cooling(int *Typ, float *u, float *uAC, int N)
{
