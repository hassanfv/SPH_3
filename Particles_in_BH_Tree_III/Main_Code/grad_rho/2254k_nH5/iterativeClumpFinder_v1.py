...
filename = './Outputs/G-0.013642.bin'

unit_velocity_cgs = 1.98766e+06 # cm/s #!!!!!!!!!!!!!!!!!!!!!!!!
unit_u = 3.95078e+12 #!!!!!!!!!!!!!!!!!!!!!!!!
unit_rho = 6.21563e-24 # !!!!!!!!!!!!!!!!!!!
...
ntmp = ntmpx[np.where(nH_cgs[ntmpx] > 200)[0]] #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
clumps = find_clumps(particles, ntmp, min_particles=50)
maxi = 0
