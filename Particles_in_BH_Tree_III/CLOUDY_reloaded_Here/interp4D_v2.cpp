...
//===== doCloudyHCooling
float doCloudyHCooling(float nH_p, float u_p, float r_p, float NH_p, float *nH, float *T, float *r, float *NH, float *uarr, float *muarr,
...
int main()
{
  ...
  float Unit_u_in_cgs = 1.80046e+12; //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  float dt = 5e-8;
  float unitTime_in_s = 2.29987e+15; //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  cout << "u before HCooling = " << u_p/Unit_u_in_cgs << endl;

  printf("XCheck: Gam_minus_Lam = %E\n", Gam_minus_Lam);
  printf("XCheck: rhocgs = %E\n", rho);
  printf("XCheck: dt_sec = %E\n", dt_sec);
  printf("XCheck: Unit_u_in_cgs = %E\n", Unit_u_in_cgs);

  u_p = u_p + Gam_minus_Lam / rho * dt_sec;
  
  cout << "u after HCooling = " << u_p/Unit_u_in_cgs << endl;
